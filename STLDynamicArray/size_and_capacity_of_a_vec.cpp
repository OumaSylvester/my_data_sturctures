...
int main()
{
    ...
    //Instantiate a vector object that holds 5 integers of default
    vector<int> vecIntegers(5);

    cout<<"Vector of integers was instantiated with "<<endl;
    cout<<"Size: "<<vecIntegers.size()<<", Capacity: "<<vecIntegers.capacity()<<endl;

    //Inserting a 6th element in to the vector
    vecIntegers.push_back(6666);
